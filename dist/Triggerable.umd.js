(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Triggerable"] = factory();
	else
		root["Triggerable"] = factory();
...
// CONCATENATED MODULE: ./src/Triggerable.js
...
/* harmony default export */ var Triggerable = ({
  ...
  methods: {
    divideUnit: function divideUnit(dividend, divisor) {
      var _dividend$match = dividend.match(/^(\d+)(\w+)/),
          _dividend$match2 = _slicedToArray(_dividend$match, 3),
          match = _dividend$match2[0],
          value = _dividend$match2[1],
          unit = _dividend$match2[2];

      if (match) {
        return "".concat(parseFloat(value, 10) / divisor).concat(unit);
      }
     ...
     * @return void
     */
    initializeTarget: function initializeTarget() {
...
/* harmony default export */ var index = (Triggerable);
...
//# sourceMappingURL=Triggerable.umd.js.map